...
p.nominalBounds = new cjs.Rectangle(0,0,141,116);


(lib.pack2 = function() {
	this.initialize(img.pack2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,273,273);


(lib.pack3 = function() {
	this.initialize(img.pack3);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,162,162);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(43,156);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.white, new cjs.Rectangle(5,128.2,76.1,55.60000000000002), null);
...
if (reversed == null) { reversed = false; }
	...
	// subhed
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#E52823").s().p("");
	this.shape.setTransform(43,156);
...
}).prototype = getMCSymbolPrototype(lib.shopbig, new cjs.Rectangle(4.6,3.1,213.9,180.70000000000002), null);
...
}).prototype = getMCSymbolPrototype(lib.prod3, new cjs.Rectangle(78,-18,141,116), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(21,56);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.prod2, new cjs.Rectangle(21,56,162,162), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-61,-101);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.prod1, new cjs.Rectangle(-61,-101,273,273), null);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(81.106,378.2723,2.2126,2.2126);
	...
	this.shape_1.setTransform(70.5443,406.3753,2.2126,2.2126);
	...
	this.shape_2.setTransform(186.5399,417.9915,2.2126,2.2126);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgWg+IApgBIAoB8IglAAIgFgNIgiABIgDANIglACgAAIAUIgJggIgIAgIARAAg");
	this.shape_3.setTransform(130.948,401.1203,2.2126,2.2126);
	...
	this.shape_4.setTransform(157.8866,402.116,2.2126,2.2126);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("Ag6g3IAngGIAUA3IAWg8IAngEIALB6IgqAEIgDgsIgSAuIgSADIgRgsIgEAvIgrAHg");
	this.shape_5.setTransform(100.2479,403.7201,2.2126,2.2126);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(40.5,822.5,0.5,0.5,0,0,0,117,47);
	this.instance._off = true;
	...
	this.instance_1.setTransform(106.5,794.5,0.5,0.5,0,0,0,91,117);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/img1.jpg?1601525056432", id:"img1"},
		{src:"images/pack1.png?1601525056432", id:"pack1"},
		{src:"images/pack2.png?1601525056432", id:"pack2"},
		{src:"images/pack3.png?1601525056432", id:"pack3"}
	],
	preloads: []
};
