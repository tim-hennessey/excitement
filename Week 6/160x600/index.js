...
p.nominalBounds = new cjs.Rectangle(0,0,208,104);


(lib.pack2 = function() {
	this.initialize(img.pack2);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,143,218);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(41.475,154.425);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.white, new cjs.Rectangle(5.6,129.6,71.80000000000001,49.70000000000002), null);
...
if (reversed == null) { reversed = false; }
	...
	// sbhd
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#E52823").s().p("");
	this.shape.setTransform(41.475,154.425);
...
}).prototype = getMCSymbolPrototype(lib.shopbig, new cjs.Rectangle(5.6,129.6,71.80000000000001,49.70000000000002), null);
...
}).prototype = getMCSymbolPrototype(lib.prod3, new cjs.Rectangle(35,-26,208,104), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(56,79);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.prod2, new cjs.Rectangle(56,79,112,118), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(5,-76);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.prod1, new cjs.Rectangle(5,-76,143,218), null);
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/img1.jpg?1602043794816", id:"img1"},
		{src:"images/pack1.png?1602043794816", id:"pack1"},
		{src:"images/pack2.png?1602043794816", id:"pack2"},
		{src:"images/pack3.png?1602043794816", id:"pack3"}
	],
	preloads: []
};
