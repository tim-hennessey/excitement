...
p.nominalBounds = new cjs.Rectangle(0,0,167,137);// helper functions:
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#FFFFFF").s().p("");
	this.shape.setTransform(332.075,41.1);

	this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.white, new cjs.Rectangle(275.4,11.8,113.40000000000003,58.60000000000001), null);
...
}).prototype = getMCSymbolPrototype(lib.subprod2, new cjs.Rectangle(0,0,172,107), null);
...
if (reversed == null) { reversed = false; }
	...
	// subhed
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#E52823").s().p("");
	this.shape.setTransform(332.075,41.1);
...
}).prototype = getMCSymbolPrototype(lib.shopbig, new cjs.Rectangle(4.6,3.1,384.2,67.30000000000001), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-30,63,1.1576,1.1576);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.prod2, new cjs.Rectangle(-30,63,193.3,158.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-41,16,0.85,0.85);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.prod1, new cjs.Rectangle(-41,16,110.5,105.4), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(89).to({_off:false},0).to({x:497.8,y:135.35},39,cjs.Ease.quintOut).wait(145));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(92).to({_off:false},0).to({regY:117.4,x:528.6,y:138.25},39,cjs.Ease.quintOut).wait(142));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(91).to({_off:false},0).to({x:501.85,y:146.5},39,cjs.Ease.quintOut).wait(143));
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(48.45,30.25,1.0723,1.0723,0,0,0,68.1,55.1);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.prod3, new cjs.Rectangle(-24.5,-28.8,184.4,114.7), null);
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(90).to({_off:false},0).to({x:480.2,y:158.35},39,cjs.Ease.quintOut).wait(144));
...
if (reversed == null) { reversed = false; }
	...
	this.timeline.addTween(cjs.Tween.get(this.cta).wait(87).to({regX:60.5,regY:14,scaleX:1.1498,scaleY:1.1498,x:843.55,y:109.1},0).to({regX:59.6,regY:13.1,scaleX:1.1504,scaleY:1.1504,x:646.55,y:109.05},39,cjs.Ease.quintOut).wait(147));
...
if (reversed == null) { reversed = false; }
	...
	this.actionFrames = [0,87,126,272];
	...
	// actions tween:
	this.timeline.addTween(cjs.Tween.get(this).call(this.frame_0).wait(87).call(this.frame_87).wait(39).call(this.frame_126).wait(146).call(this.frame_272).wait(1));
	...
	this.cta.name = "cta";
	this.cta.setTransform(70.9,316.9,1,1,0,0,0,70.9,396.9);
	this.cta.depth = 0;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/cat.jpg?1602615384588", id:"cat"},
		{src:"images/pack1.png?1602615384588", id:"pack1"},
		{src:"images/pack2.png?1602615384588", id:"pack2"},
		{src:"images/pack3.png?1602615384588", id:"pack3"}
	],
	preloads: []
};
